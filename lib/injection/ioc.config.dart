...
import 'package:products_repository/products_repository.dart' as _i5;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  await gh.factoryAsync<_i4.Store<_i4.CacheInfo, _i4.CacheEntry>>(
      ...
      preResolve: true);
  await gh.lazySingletonAsync<_i5.IProductsRepository>(
      () => injectableModule
          .productsRepository(get<_i4.Store<_i4.CacheInfo, _i4.CacheEntry>>()),
      preResolve: true);
  return get;
}
